...
import users.busUser.busAttributeEnum;
...
import users.taxiUser.taxiAttributeEnum;
...
;
    ...
    public String createQuery(String prefix, String suffix, String k_pattern, String predEvent, String preAggregator){
        ...
        String predicate = predicate(predEvent);

        String whereString = whereString(predEvent, predicate,  groubyColumn);
