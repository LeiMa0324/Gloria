...
/**
 * load the gloria.stream file into a arraylist of events
 */
public class streamLoader {
    ...
    /**
     * dispatch the events to different gloria.workload
     * @param data
