...
public class partitionSetCreator<T> {
    ...
    private Set<T> base;//the gloria.base set
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("\ngloria.base size: "+ baseSet.size()+", partition size: "+partitionSets.size());
    }
    ...
    /**
     * Creates a power set from the gloria.base set.
     */
