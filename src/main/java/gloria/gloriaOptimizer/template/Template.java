...
import gloria.gloriaOptimizer.template.EventType.EndEventType;
import gloria.gloriaOptimizer.template.EventType.EventType;
import gloria.gloriaOptimizer.template.EventType.RealEventType;
...
public class Template {
    ...
    /**
     * load the GloriaOptimizer.template from a gloria.workload
     * @param workload
     */
