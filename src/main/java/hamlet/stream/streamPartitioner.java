...
/**
 * partition the gloria.stream into sub streams for each mini-gloria.workload
 */
@Data
public class streamPartitioner {
    ...
    /**
     * partition the gloria.stream into substreams according to the groupby
    ...
    public HashMap<Object, ArrayList<Event>> partition(){
        ...
        for (Event e: events){
            ...
            // if e is not relevant in this mini-gloria.workload
    ...
    /**
     * scan the gloria.stream to find all group-by values
    ...
    /**
     * add a group-by event into a specific sub gloria.stream
     * @param e
     */
