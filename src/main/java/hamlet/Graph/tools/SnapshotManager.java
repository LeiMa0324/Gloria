...
public class SnapshotManager {
    ...
    public void createGraphletSnapshot(Graphlet lastKleeneGraphlet, int eventIndex, HashMap<Integer, Value> prefixCounts, ArrayList<Event> burst){
        ...
        Snapshot newGraphletSnapshot = new Snapshot(lastKleeneGraphlet,eventIndex, prefixCounts, burst.get(0).getType());
        ...
        validStartQueries.retainAll(Utils.getInstance().getTemplate().getQueriesStartWithEventType(burst.get(0).getType()));
