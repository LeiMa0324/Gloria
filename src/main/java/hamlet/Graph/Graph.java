...
public abstract class Graph {
    ...
    public void setUtils(){
        ...
        kleeneEventCountManager.setPredicateManager(this.predicateManager);
    ...
    public void printGraphletSnapshot(){
        ...
        for (int qid: snapshot.getValues().keySet()){
            System.out.printf("gloria/query " +qid+"     count: " +snapshot.getValues().get(qid).getCount()+"\n");
            System.out.printf("gloria/query " +qid+"       sum: " +snapshot.getValues().get(qid).getSum()+"\n");
    ...
    public void printFinalCount(){
        ...
        for (int qid: this.finalValues.keySet()){
            ...
            System.out.printf("gloria.query: "+ qid);
