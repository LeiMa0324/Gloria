...
public class WorkloadAnalyzer {
    ...
    public HashMap<String, Workload> analyzeToMiniWorkloads(String workloadFile){
        ...
        for (Query q: queries){
            ...
            if (isSharable){
                ...
                System.out.printf("Cannot share this gloria.query with any queries!");
            }
        }
        return miniloads;
    }
    ...
    /**
     * check if the gloria.query has the same kleene event type with the mini gloria.workload
     * @param query a given gloria.query
     * @param workload a mini gloria.workload
     * @return boolean
     */
