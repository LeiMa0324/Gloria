...
import baselines.exhaustive.partitionSetCreator;
import gloriaOptimizer.graph.OptimizerType;
import gloriaOptimizer.graph.Transition.Transition;
import gloriaOptimizer.graph.TransitionOperation.EndOperation;
import gloriaOptimizer.graph.TransitionOperation.MergeOperation;
import gloriaOptimizer.graph.TransitionOperation.ReuseOperation;
